...
namespace Events.API.Migrations.Event
{
    ...
    [Migration("20210517035802_Added_New_References")]
    partial class Added_New_References
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Events.API.Models.Group", b =>
                {
                    ...
                    b.HasOne("Events.API.Models.Group", "GroupParent")
                        .WithMany("ChildGroups")
                        .HasForeignKey("GroupParentId");

                    b.Navigation("Event");

                    b.Navigation("GroupParent");
                });

            modelBuilder.Entity("Events.API.Models.GroupItem", b =>
                {
                    b.HasOne("Events.API.Models.Group", "Group")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Events.API.Models.GroupItemVote", b =>
                {
                    b.HasOne("Events.API.Models.GroupItem", "GroupItem")
                        .WithMany("Votes")
