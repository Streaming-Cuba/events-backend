...
namespace Events.API.Migrations.Event
{
    ...
    [Migration("20210426220730_Added_Vote_Type")]
    partial class Added_Vote_Type
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Events.API.Models.GroupItemMetadata", b =>
                {
                    ...
                    b.Property<string>("ProductorHome")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Events.API.Models.GroupItemSocial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Events.API.Models.GroupItemVote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("GroupItemVote");
                });

            modelBuilder.Entity("Events.API.Models.GroupItemVoteType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Events.API.Models.GroupItemVote", b =>
                {
                    b.HasOne("Events.API.Models.GroupItem", null)
                        .WithMany("Votes")
                        .HasForeignKey("GroupItemId");

                    b.HasOne("Events.API.Models.GroupItemVoteType", "Type")
                        .WithMany()
                        .HasForeignKey("TypeId");
